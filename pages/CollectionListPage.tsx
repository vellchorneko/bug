...
const forestAssets = {
  ...
  homeIcon: `${ASSET_BASE}/achievement_home_icon.png`,
};
 ...
 * レア度ごとのカード色クラス名を返す。
 */
const getRarityClassName = (rarity: string): string => {
  switch (rarity) {
    case 'SR':
      return 'rarity-sr';
    case 'R':
...
const CollectionListPage: React.FC<CollectionListPageProps> = ({ onClose }) => {
  ...
  return (
        ...
        {`
          ...
          */
          ...
          .wood-close-button-inner {
            ...
            pointer-events: none;
            user-select: none;
            filter: drop-shadow(0 5px 8px rgba(76, 57, 42, 0.18));
          }
          ...
          */
          ...
          /* SR：金 */
          .collection-frame-wrap.acquired.rarity-sr .collection-frame-img {
            filter:
              brightness(1.05)
              contrast(1.10)
              saturate(1.55)
              sepia(0.18)
              hue-rotate(-6deg)
              drop-shadow(0 0 5px rgba(255, 226, 96, 0.48))
              drop-shadow(0 0 11px rgba(219, 168, 45, 0.32))
              drop-shadow(0 4px 10px rgba(174, 125, 32, 0.26));
          }

          /* R：銀 */
          .collection-frame-wrap.acquired.rarity-r .collection-frame-img {
            filter:
               grayscale(1)
    brightness(0.88)
    contrast(1.34)
    ...
    sepia(0.03)
    hue-rotate(185deg)
    drop-shadow(0 0 5px rgba(226, 232, 238, 0.42))
    drop-shadow(0 4px 9px rgba(104, 116, 130, 0.26));
          }

          /* C：銅 */
          .collection-frame-wrap.acquired.rarity-c .collection-frame-img {
             filter:
    sepia(1)
brightness(0.99)
    saturate(1.85)
    ...
    brightness(0.82)
    contrast(1.26)
    drop-shadow(0 4px 9px rgba(105, 62, 36, 0.26));
          }
/*
  レア度色に変えたフレームの上から、
  右下の取得済みマーク部分だけ元画像を表示する。
*/
.collection-frame-marker-img {
  position: absolute;
  inset: 0;
  width: 100%;
  height: 100%;
  ...
  user-select: none;
  z-index: 4;
  clip-path: circle(8px at 112px 100px);
}
          ...
          /*
            ...
            レア度の違いはカード色だけで表現する。
          */
          .collection-button .collection-number {
            margin-top: 4px;
            color: #4d6a45;
            font-size: 17px;
            font-weight: 800;
      ...
      <div className="forest-modal">
        ...
        <button
          ...
          aria-label="home"
        >
          <img src={forestAssets.homeIcon} alt="home" className="wood-close-button-inner" />
        </button>
            ...
            <div className="collection-grid">
              {!isLoading
                && collections.map((collection, index) => {
                  ...
                  const rarityClassName = getRarityClassName(collection.rarity);
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`collection-frame-wrap ${acquired ? `acquired ${rarityClassName}` : 'locked'}`}
                      >
                        <img src={forestAssets.frame} alt="" className="collection-frame-img" />

                        {acquired && (
                          <img
                            src={forestAssets.frame}
                            alt=""
                            className="collection-frame-marker-img"
                          />
                        )}
            ...
            >
              ...
              <div
                style={{
                  ...
                  margin: '0 auto 16px',
                  borderRadius: '12px',
                  backgroundColor: selectedCollection.acquired ? '#f7f3e7' : '#f4f4f4',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  overflow: 'hidden',
